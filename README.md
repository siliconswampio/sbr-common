...
`npm install https://github.com/siliconswampio/sbr-common.git`
...
```javascript
const mainnetGenesisState = require('@sbr/common/dist/genesisStates/mainnet')
```

Or by accessing dynamically:

```javascript
const genesisStates = require('@sbr/common/dist/genesisStates')
